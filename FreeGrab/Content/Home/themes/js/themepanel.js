jQuery(document).ready(function($) {
    ...
    var linkcss = 'http://asianitbd.com/wp/charityclub/wp-content/themes/charityclub/';
  ...
  if ($.cookie('boxed') == "yes") {
            ...
            $("body .page-wrapper").addClass("boxed");
  ...
  if ($.cookie('boxed') == "no") {
    ...
    $("body .page-wrapper").removeClass("boxed");
